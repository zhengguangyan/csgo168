<template>
  <div id="Lucky">
    <div id="Lucky-box">
      ...
      <!-- </div>  -->
      <div class="hot"><span class="hot_text">热门推荐</span></div>
      <div class="Lucky-list-box">
        <div class="Lucky-list-out">
          ...
          <div class="Goods_list">
            <div  :class="'lv_' + item.lv" v-for="(item, index) in equipmentlist" :key="index"
...
#Lucky-box {
  ...
  .hot {
    width: 100%;
    // height: 91px;
    background: url(../../assets/images/xinyunkaixiang/img_zhubobaoxiang.png) no-repeat;
  ...
  .Goods_list {
    ...
    .Goods_item {
      ...
      cursor: pointer;
      position: relative;
      background:url(../../assets/images/xinyunkaixiang/xuanzhuan.png) no-repeat;
      background-size: 100% 100%;
